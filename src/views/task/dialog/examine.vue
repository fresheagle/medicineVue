            ...
            <div class="body">
              <el-form ref="formData" :model="formData" label-width="80px">
                <el-row>
                  ...
                  <el-col :span="11">
                    <el-form-item >
                      <el-input v-model="formData.jsonStr.missInstitution.category"
                                type="textarea" placeholder="审核意见"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="5">
                    <el-form-item>
                      <el-input v-model="formData.jsonStr.missInstitution.category" placeholder="得分"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
