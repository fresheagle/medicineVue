          ...
          <div class="card">
            ...
            <div class="body">
              ...
              <div v-if="formData.taskStatus === 'secAuditeding'">
                <el-collapse accordion>
                  <el-collapse-item title="初审信息" name="fisrtTrailApproval">
                    <el-form ref="formData" :model="formData" label-width="80px">
                      ...
                      <el-form-item label="得分">
                        <el-input  v-model="approvsls.gravidaDurg.firstApprovalPoint"></el-input>
                      </el-form-item>
                      <el-form-item label="时间">
                ...
                <el-form ref="formData" :model="formData" label-width="80px">
                  <el-form-item label="二审">
                    <el-radio-group v-model="approvsls.gravidaDurg.secondTrailApprovalResult">
                      <el-radio-button label="通过">通过</el-radio-button>
                      <el-radio-button label="不通过">不通过</el-radio-button>
                    </el-radio-group>
                  </el-form-item>
              ...
              <div v-if="formData.taskStatus === 'finalAuditeding'">
                <el-collapse accordion>
                  ...
                  <el-collapse-item title="二审信息" name="secondTrailApproval">
                    <el-form ref="formData" :model="formData" label-width="80px">
                      ...
                      <el-form-item label="得分">
                        <el-input v-model="approvsls.gravidaDurg.secondApprovalPoint"></el-input>
                      </el-form-item>
                      <el-form-item label="时间">
                ...
                <el-form ref="formData" :model="formData" label-width="80px">
                  <el-form-item label="终审">
                    <el-radio-group v-model="approvsls.gravidaDurg.finalTrailApprovalResult">
                      <el-radio-button label="通过">通过</el-radio-button>
                      <el-radio-button label="不通过">不通过</el-radio-button>
                    </el-radio-group>
                  </el-form-item>
          ...
          <div class="card">
            ...
            <div class="body">
              ...
              <div v-if="formData.taskStatus === 'secAuditeding'">
                <el-collapse accordion>
                  <el-collapse-item title="初审信息" name="fisrtTrailApproval">
                    <el-form ref="formData" :model="formData" label-width="80px">
                      ...
                      <el-form-item label="得分">
                        <el-input  v-model="approvsls.childrenDurg.firstApprovalPoint"></el-input>
                      </el-form-item>
                      <el-form-item label="时间">
                ...
                <el-form ref="formData" :model="formData" label-width="80px">
                  <el-form-item label="二审">
                    <el-radio-group v-model="approvsls.childrenDurg.secondTrailApprovalResult">
                      <el-radio-button label="通过">通过</el-radio-button>
                      <el-radio-button label="不通过">不通过</el-radio-button>
                    </el-radio-group>
                  </el-form-item>
              ...
              <div v-if="formData.taskStatus === 'finalAuditeding'">
                <el-collapse accordion>
                  ...
                  <el-collapse-item title="二审信息" name="secondTrailApproval">
                    <el-form ref="formData" :model="formData" label-width="80px">
                      ...
                      <el-form-item label="得分">
                        <el-input v-model="approvsls.childrenDurg.secondApprovalPoint"></el-input>
                      </el-form-item>
                      <el-form-item label="时间">
                ...
                <el-form ref="formData" :model="formData" label-width="80px">
                  <el-form-item label="终审">
                    <el-radio-group v-model="approvsls.childrenDurg.finalTrailApprovalResult">
                      <el-radio-button label="通过">通过</el-radio-button>
                      <el-radio-button label="不通过">不通过</el-radio-button>
                    </el-radio-group>
                  </el-form-item>
          ...
          <div class="card">
            ...
            <div class="body">
              ...
              <div v-if="formData.taskStatus === 'secAuditeding'">
                <el-collapse accordion>
                  <el-collapse-item title="初审信息" name="fisrtTrailApproval">
                    <el-form ref="formData" :model="formData" label-width="80px">
                      ...
                      <el-form-item label="得分">
                        <el-input  v-model="approvsls.elderlyDurg.firstApprovalPoint"></el-input>
                      </el-form-item>
                      <el-form-item label="时间">
                ...
                <el-form ref="formData" :model="formData" label-width="80px">
                  <el-form-item label="二审">
                    <el-radio-group v-model="approvsls.elderlyDurg.secondTrailApprovalResult">
                      <el-radio-button label="通过">通过</el-radio-button>
                      <el-radio-button label="不通过">不通过</el-radio-button>
                    </el-radio-group>
                  </el-form-item>
              ...
              <div v-if="formData.taskStatus === 'finalAuditeding'">
                <el-collapse accordion>
                  ...
                  <el-collapse-item title="二审信息" name="secondTrailApproval">
                    <el-form ref="formData" :model="formData" label-width="80px">
                      ...
                      <el-form-item label="得分">
                        <el-input v-model="approvsls.elderlyDurg.secondApprovalPoint"></el-input>
                      </el-form-item>
                      <el-form-item label="时间">
                ...
                <el-form ref="formData" :model="formData" label-width="80px">
                  <el-form-item label="终审">
                    <el-radio-group v-model="approvsls.elderlyDurg.finalTrailApprovalResult">
                      <el-radio-button label="通过">通过</el-radio-button>
                      <el-radio-button label="不通过">不通过</el-radio-button>
                    </el-radio-group>
                  </el-form-item>
          ...
          <div class="card">
            ...
            <div class="body">
              ...
              <div v-if="formData.taskStatus === 'secAuditeding'">
                <el-collapse accordion>
                  <el-collapse-item title="初审信息" name="fisrtTrailApproval">
                    <el-form ref="formData" :model="formData" label-width="80px">
                      ...
                      <el-form-item label="得分">
                        <el-input  v-model="approvsls.durgOverdose.firstApprovalPoint"></el-input>
                      </el-form-item>
                      <el-form-item label="时间">
                ...
                <el-form ref="formData" :model="formData" label-width="80px">
                  <el-form-item label="二审">
                    <el-radio-group v-model="approvsls.durgOverdose.secondTrailApprovalResult">
                      <el-radio-button label="通过">通过</el-radio-button>
                      <el-radio-button label="不通过">不通过</el-radio-button>
                    </el-radio-group>
                  </el-form-item>
              ...
              <div v-if="formData.taskStatus === 'finalAuditeding'">
                <el-collapse accordion>
                  ...
                  <el-collapse-item title="二审信息" name="secondTrailApproval">
                    <el-form ref="formData" :model="formData" label-width="80px">
                      ...
                      <el-form-item label="得分">
                        <el-input v-model="approvsls.durgOverdose.secondApprovalPoint"></el-input>
                      </el-form-item>
                      <el-form-item label="时间">
                ...
                <el-form ref="formData" :model="formData" label-width="80px">
                  <el-form-item label="终审">
                    <el-radio-group v-model="approvsls.durgOverdose.finalTrailApprovalResult">
                      <el-radio-button label="通过">通过</el-radio-button>
                      <el-radio-button label="不通过">不通过</el-radio-button>
                    </el-radio-group>
                  </el-form-item>
          ...
          <div class="card">
            ...
            <div class="body">
              ...
              <div v-if="formData.taskStatus === 'secAuditeding'">
                <el-collapse accordion>
                  <el-collapse-item title="初审信息" name="fisrtTrailApproval">
                    <el-form ref="formData" :model="formData" label-width="80px">
                      ...
                      <el-form-item label="得分">
                        <el-input  v-model="approvsls.pharmacokinetics.firstApprovalPoint"></el-input>
                      </el-form-item>
                      <el-form-item label="时间">
                ...
                <el-form ref="formData" :model="formData" label-width="80px">
                  <el-form-item label="二审">
                    <el-radio-group v-model="approvsls.pharmacokinetics.secondTrailApprovalResult">
                      <el-radio-button label="通过">通过</el-radio-button>
                      <el-radio-button label="不通过">不通过</el-radio-button>
                    </el-radio-group>
                  </el-form-item>
              ...
              <div v-if="formData.taskStatus === 'finalAuditeding'">
                <el-collapse accordion>
                  ...
                  <el-collapse-item title="二审信息" name="secondTrailApproval">
                    <el-form ref="formData" :model="formData" label-width="80px">
                      ...
                      <el-form-item label="得分">
                        <el-input v-model="approvsls.pharmacokinetics.secondApprovalPoint"></el-input>
                      </el-form-item>
                      <el-form-item label="时间">
                ...
                <el-form ref="formData" :model="formData" label-width="80px">
                  <el-form-item label="终审">
                    <el-radio-group v-model="approvsls.pharmacokinetics.finalTrailApprovalResult">
                      <el-radio-button label="通过">通过</el-radio-button>
                      <el-radio-button label="不通过">不通过</el-radio-button>
                    </el-radio-group>
                  </el-form-item>
