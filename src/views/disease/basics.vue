<template>
  <div class="app-container">
    ...
    <el-table :data="tableList" v-loading="listLoading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column prop="jsonStr.missDisease.englishName" label="英文名称">
        <template slot-scope="scope">
          {{scope.row.jsonStr.missDisease.englishName}}
        </template>
      </el-table-column>
      <el-table-column prop="jsonStr.missDisease.latinName" label="拉丁名称">
        <template slot-scope="scope">
          {{scope.row.jsonStr.missDisease.latinName}}
        </template>
      </el-table-column>
      <el-table-column prop="jsonStr.missDisease.otherName" label="其它名称">
        <template slot-scope="scope">
          {{scope.row.jsonStr.missDisease.otherName}}
        </template>
      </el-table-column>
      <el-table-column prop="jsonStr.missDisease.relatedDiseases" label="相关疾病">
        <template slot-scope="scope">
          {{scope.row.jsonStr.missDisease.relatedDiseases}}
        </template>
      </el-table-column>
