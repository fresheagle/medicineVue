      ...
      <el-row >
        <el-col :span="12" class="rowClass">
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="疾病分类">
                      <el-select v-model="formData.jsonStr.missChineseDisease.diseaseType" >
                        <el-option
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="就诊科室" prop="departmentId">
                      <el-select v-model="formData.jsonStr.missChineseDisease.departmentId" >
                        <el-option
          ...
          <div class="card">
            ...
            <div class="body">
              <div>
                <quill-editor ref="myTextEditor" v-model="formData.jsonStr.missChineseDisease.历史沿革" :options="editorOption"></quill-editor>
              </div>
            </div>
          </div>
          <div class="card">
    ...
    methods: {
      ...
      * */
      ...
      doAddLeaderMsg() {
        ...
        this.formData.jsonStr.missChineseDisease.leadteamInfo.push(param)
      ...
      deleteLeadteamInfo(index) {
        this.formData.jsonStr.missChineseDisease.leadteamInfo.splice(index, 1)
      },
      /*
       *医院环境信息
       * */
      ...
      doAddEnvironmentMsg() {
        ...
        this.formData.jsonStr.missChineseDisease.environment.push(param)
      ...
      deleteEnvironment(index) {
        this.formData.jsonStr.missChineseDisease.environment.splice(index, 1)
      },
      /**
       * 科室设置
       * */
