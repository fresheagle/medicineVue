<template>
  <div class="app-container">
    ...
    <el-table :data="tableList" v-loading="listLoading" border element-loading-text="拼命加载中" style="width: 100%;">
      <el-table-column prop="jsonStr.missMedicalCompany.chineseName" label="中文名称">
        <template slot-scope="scope">
          {{scope.row.jsonStr.missMedicalCompany.chineseName}}
        </template>
      </el-table-column>
      <el-table-column prop="jsonStr.missMedicalCompany.englishName" label="英文名称">
        <template slot-scope="scope">
          {{scope.row.jsonStr.missMedicalCompany.englishName}}
        </template>
      </el-table-column>
    ...
    <create-enterprise-dialog :visible.sync="isShowCreateVisible" :row-data="curRowData"
