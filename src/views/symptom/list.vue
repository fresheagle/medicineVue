<template>
  <div class="app-container">
    ...
    <el-table :data="tableList" v-loading="listLoading" border element-loading-text="拼命加载中" style="width: 100%;">
      <el-table-column prop="jsonStr.missSymptom.chineseName" label="中文名称">
        <template slot-scope="scope">
          {{scope.row.jsonStr.missSymptom.chineseName}}
        </template>
      </el-table-column>
      <el-table-column prop="jsonStr.missSymptom.englishName" label="英文别名">
        <template slot-scope="scope">
          {{scope.row.jsonStr.missSymptom.englishName}}
        </template>
      </el-table-column>
    ...
    <create-symptom-dialog :visible.sync="isShowCreateVisible" :row-data="curRowData"
