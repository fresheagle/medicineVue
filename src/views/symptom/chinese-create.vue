                ...
                <el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item label="传染性">
                      <el-input v-model="formData.jsonStr.missChineseSymptom.infectivity" placeholder="传染性"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="相关疾病(old)">
                      <el-input v-model="formData.jsonStr.missChineseSymptom.commonDiseasesOld" placeholder="相关疾病(old)"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      doCheck() {
        const params = {
          name: this.formData.jsonStr.missChineseSymptom.englishName
        }
