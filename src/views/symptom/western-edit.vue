  ...
  export default {
    ...
    data() {
      return {
        ...
        refrencesPicList: [],
        keyArr: [{ key: 'epidemiology', value: '流行病学' }, { key: 'symptomOrigin', value: '症状起因' }, { key: 'clinicalManifestation', value: '临床表现' },
    ...
    methods: {
      ...
      doCheck() {
        const params = {
          ...
          englishName: this.formData.jsonStr.missWesternSymptom.englishName,
          otherName: this.formData.jsonStr.missWesternSymptom.otherName
        }
      ...
      doAdddepartment() {
        ...
        this.formData.jsonStr.missWesternSymptom.departmentMapDTO.push(param)
      },
